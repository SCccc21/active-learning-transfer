...
rank_coll_dir = coll_dir + trans_type + '_' + corruption +'_optimal.rank'
acc_coll_dir = coll_dir + trans_type + '_' + corruption + '_optimal.acc'
...
for select_seed in range(6):
  ...
  pickle.dump(optimal_rank_coll, open(rank_coll_dir, 'wb'))
